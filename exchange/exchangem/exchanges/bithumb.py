...
class Bithumb(Base):
    ...
    def get_balance(self, target):
        ...
        balance.add(target, ret[target]["total"], ret[target]["used"], ret[target]["free"])
    ...
    def get_all_balance(self):
        ...
        data = ret["info"]["data"]
        balance.add("KRW", data["total_krw"], data["in_use_krw"], data["available_krw"])
    ...
    ex = Bithumb(
        {
            ...
            "config_file": "configs/bithumb.conf",
        }
    )
