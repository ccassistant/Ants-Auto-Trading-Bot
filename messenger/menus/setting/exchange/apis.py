...
class ApiAdd(MenuItem):
    ...
    def save_apikey(self):
        ...
        try:
            ...
            key_set = {"apiKey": en_apiKey, "secret": en_secret}
...
class ApiTest(MenuItem):
    ...
    def do_test(self, coin_name=None):
        ...
        try:
            ...
            self.logger.debug(
                "load class {}\tconfig file : {}\tkey file: {}".format(
                    class_name, exchange_setting_conf, config_file
                )
            )
            ...
            exchange = klass(
                {
                    ...
                    "key_file": "not_used_20200503",
                    "config_file": exchange_setting_conf,
                }
            )
            ...
            self.logger.debug(
                "Availabel {} size : {}".format(coin_name, exchange.get_availabel_size(coin_name))
            )
